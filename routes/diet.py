...
# Mount static files
diet.mount("/static", StaticFiles(directory="static"), name="static")
...
@diet.get("/api/meals", response_model=List[Meal])
...
@diet.get("/api/meals/{meal_id}", response_model=Meal)
...
@diet.post("/api/meals", response_model=Meal)
